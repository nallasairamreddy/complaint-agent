  ...
  return (
    <div className="p-8 max-w-3xl">
      ...
      {complaint.status === 'Escalated' && priorityChange && (
        <div
          className="mb-6 bg-signal-amber/10 border border-signal-amber/30 rounded-xl px-5 py-4 animate-fade-up opacity-0"
      ...
      <div
        className="grid grid-cols-3 gap-4 mb-6 animate-fade-up opacity-0"
      ...
      <div
        className="bg-ink-900 border border-ink-700 rounded-xl p-5 mb-6 animate-fade-up opacity-0"
      ...
      {complaint.status === 'Pending' && (
        <div
          className="bg-ink-900 border border-ink-700 rounded-xl p-5 animate-fade-up opacity-0"
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    value={fb.new_priority}
                    onChange={e => setFb({ ...fb, new_priority: e.target.value })}
                ...
                <div>
                  ...
                  <select
                    value={fb.new_department}
                    onChange={e => setFb({ ...fb, new_department: e.target.value })}
                    className="w-full bg-ink-800 border border-ink-600 focus:border-signal-blue rounded-lg px-3 py-2.5 text-sm text-white outline-none transition-colors"
                  >
      ...
      {complaint.status !== 'Pending' && (
        <div
          className={`rounded-xl px-5 py-4 border text-sm font-mono animate-fade-up opacity-0 ${
            complaint.status === 'Resolved'
              ? 'bg-signal-green/10 border-signal-green/30 text-signal-green'
              : 'bg-signal-amber/10 border-signal-amber/30 text-signal-amber'
          }`}
